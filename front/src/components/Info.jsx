...
export default function Info() {
    return(
        ...
        <div id="info">
            ...
            <ul>
                <li className="texto">Soy desarrolladora Web Full Stack, estudiante de la Tecnicatura Universitaria de Desarrollo de Software de la UPE y egresada de Henry Bootcamp.</li>
            ...
            <a href= "https://drive.google.com/file/d/1_MfDQH0ZfDQeTiIePR1BlWGN3Pd5Svps/view" target="_blank" rel="noopener noreferrer" className='botoncito cv'>
